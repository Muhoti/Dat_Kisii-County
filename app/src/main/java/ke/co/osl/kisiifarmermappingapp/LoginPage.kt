...
import ke.co.osl.kisiifarmermappingapp.models.RecoverPasswordBody
...
//        Theme_Black_NoTitleBar_Fullscreen - style theme changed from...
    ...
    private fun postLoginDetails(){
        ...
        next.setOnClickListener {
            ...
            val loginBody = ke.co.osl.kisiifarmermappingapp.models.LoginBody(
                email.text.toString(),
            ...
            apiInterface.enqueue( object : Callback<Message> {
                override fun onResponse(call: Call<Message>?, response: Response<Message>?) {
                    ...
                    System.out.println("HEY THERE" + response?.body())
            ...
            //startActivity(Intent(this@LoginPage,FarmerDetails::class.java))
        }
    }
